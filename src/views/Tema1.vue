...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.fond3.p-4.mb-5
      ...
      .row
        .col-lg-6             
          img.mb-4(src='@/assets/tema1/img-7.svg', alt='Tipos de titulares', style="width:450px;").m-auto
        ...
        .col-lg-6          
          img.mb-4(src='@/assets/tema1/img-8.svg', alt='Tipos de titulares', style="width:450px;").m-auto
          ...
          .row
            .col-md-6
              .ul.lista-ul--color
                li 
                  i.fas.fa-caret-right
                  p.mb-0 Precio de lista
                li 
                  i.fas.fa-caret-right
                  p.mb-0 Descuentos                
                li 
                  i.fas.fa-caret-right
                  p.mb-0 Bonificaciones                
             
            .col-md-6.mb-5
              .ul.lista-ul--color
                li 
                  i.fas.fa-caret-right
                  p.mb-0 Periodos de pago                 
                li 
                  i.fas.fa-caret-right
                  p.mb-0 Planes de crédito           
  
                                
        .col-lg-6             
          img.mb-4(src='@/assets/tema1/img-9.svg', alt='Tipos de titulares', style="width:450px;").m-auto
          ...
          .row
            ...
            .col-md-6.mb-5
              .ul.lista-ul--color
                ...
                li 
                  i.fas.fa-caret-right
                  p.mb-0 Venta personal               
                li 
                  i.fas.fa-caret-right
                  p.mb-0 Marketing directo  
    ...
    .bloque-texto-a.custom-cl.p-4.p-md-5.mb-5 
